...
function SingleVideoComp(props) {
  return (
    <div className='videoContainer w-full m-auto mb-0 px-2 md:px-0 sm:w-11/12 md:w-2/3  lg:max-w-1/3 lg:max-w-screen'>
{/*         <div className="videoCard rounded-lg mx-auto  w-fit bg-gradient-to-b from-black via-black to-slate-900">
 */}          <div className="iframeContainer w-full relative pt-0 pb-0 m-auto  aspect-video-17/9 ">
            <iframe
