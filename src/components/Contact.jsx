...
const Contact = () => {
    return (
        <section id="contact " className='snap-start flex top-34 relative  bg-slate-200'>
            <div className="p-4 flex w-full justify-center self-center h-auto place-content-center gap-12 h-12">
